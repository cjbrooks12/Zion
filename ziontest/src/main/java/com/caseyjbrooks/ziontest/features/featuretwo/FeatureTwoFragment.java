...
public class FeatureTwoFragment extends FragmentBase {
    ...
    public Class<? extends FragmentConfiguration> getFragmentConfigurationClass() {
        return FeatureTwoFragmentConfiguraion.class;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        instanceConfiguration = new FeatureTwoFragmentConfiguraion(getContext());
    ...
    public static class FeatureTwoFragmentConfiguraion extends FragmentConfiguration {
        public FeatureTwoFragmentConfiguraion(Context context) {
            super(context);
        }
